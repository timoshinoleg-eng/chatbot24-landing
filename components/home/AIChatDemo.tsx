        ...
        {!isCompleted ? (
          ...
          <div className="text-center space-y-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => window.location.href = '/contacts'} className="flex-1 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-medium rounded-xl hover:opacity-90">
                Заполнить бриф
              </button>
